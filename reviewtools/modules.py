...
IRRELEVANT_MODULES = ['sr_common', 'sr_tests', 'sr_skeleton',
                      'common']
...
def find_main_class(module_name):
    ...
    if module is None:
        raise FileNotFoundError("could not find '%s' in: %s" % (module_name,
                                reviewtools.__path__))
